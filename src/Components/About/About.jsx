...
const About = () => {
  ...
  const text = "I am a passionate Generative AI Developer currently gaining valuable experience as a GenAI Intern at Mindzkonnected. With a strong foundation in Data Structures and Algorithms (DSA), I excel in crafting efficient and innovative solutions to complex problems. My expertise extends to Full Stack Development, where I leverage my skills to create robust and user-friendly applications. I am dedicated to pushing the boundaries of AI technology and contributing to impactful projects that shape the future.".split(" ");
   const text2 =   "My passion for development is not only reflected in my extensive experience but also in the enthusiasm and dedication I bring to each project.".split(" ")  ;
